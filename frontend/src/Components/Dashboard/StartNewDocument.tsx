...
const StartNewDocument = () => {
  return (
    <div className="flex flex-col items-center justify-center border border-gray-300 rounded-lg shadow-md p-6 w-40 h-52 hover:shadow-lg transition cursor-pointer">
